          ...
          <form className="p-6 md:p-8" onSubmit={e => e.preventDefault()}>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-muted-foreground">Login to your NAM Inc. account</p>
              </div>
              ...
              <div className="text-center text-sm">
               ...
               <div className="text-center text-xs [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
